    ...
    return (
        <ResponsiveWidth gap="1em" my="3em" sx={{
            ...
            <div className="membership-container">
                ...
                <Image w="560px" objectFit="contain" src={"/assets/membership_data_form.png"} />
                <Flex flexDir="column">
                    <Text fontWeight="medium">*When creating or renewing membership, the following should be considered:</Text>
                    <Text>To link your account to  Basrah University for Oil & Gas Student Chapter, be sure to select <b>{'(Basrah University for Oil & Gas)'}</b> even if you are not student at it</Text>
                </Flex>
                <Image src="/assets/university_membership.png" w="560px" objectFit="contain" />
                <Text>If you had any problems during the registeration process, please contact us via this <Link href="https://t.me/SPE_members_1_bot" textDecor="underline" color="#0D4C94">Telegram bot</Link></Text>
                <Text>
                    If all of your registeration attempts were not successful, you may register via this{' '}
                    <Link href="https://forms.gle/SrSvf3ZRtZfn3rdw8" textDecor="underline" color="#0D4C94">form</Link>{' '}
                    and join this{' '}
