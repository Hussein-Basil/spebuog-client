...
import { Flex, Text, Heading, Image, Link, Avatar, Icon, Show, Hide, SkeletonText, SkeletonCircle } from '@chakra-ui/react'
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {event.parent && <Text w="90%">This {event.event_type === 'course_lecture' ? 'lecture' : event.event_type} is part of the {event.parent.title}</Text>}
                    <Heading fontSize={{ base: "1.5rem", lg: "2.25rem" }} maxW="90%">
                        {event.title}
                    </Heading>
